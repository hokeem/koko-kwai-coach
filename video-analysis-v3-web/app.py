...
async function loadCurrentTab(){{if(activeTab==="creators")return loadCreators();if(activeTab==="analytics")return loadAnalytics();if(activeTab==="accounts")return loadAccounts();if(activeTab==="submissions")return loadSubmissions();if(activeTab==="intakes")return loadIntakes();if(activeTab==="imports"){{adminView();return}}return loadEntries()}}
