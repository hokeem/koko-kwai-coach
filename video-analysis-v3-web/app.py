...
CREATOR_ADMIN_TAB_ROUTES = {
    ...
    "/creator-admin/accounts": "accounts",
...
def creator_admin_html(initial_tab: str = "scripts", *, library_mode: bool = False) -> str:
    if initial_tab not in {"scripts", "imports", "creators", "accounts", "submissions", "intakes"}:
        initial_tab = "scripts"
...
function adminTabs(){{return libraryMode?`<div class="ops-tabs"><a class="active" href="/library">脚本管理</a></div>`:`<div class="ops-tabs"><a class="${{activeTab==="imports"?"active":""}}" href="/creator-admin/imports">导入脚本</a><a class="${{activeTab==="creators"?"active":""}}" href="/creator-admin/creators">创作者管理</a><a class="${{activeTab==="accounts"?"active":""}}" href="/creator-admin/accounts">账号管理</a><a class="${{activeTab==="submissions"?"active":""}}" href="/creator-admin/submissions">回传数据</a><a class="${{activeTab==="intakes"?"active":""}}" href="/creator-admin/intakes">作者信息收集</a></div>`}}
